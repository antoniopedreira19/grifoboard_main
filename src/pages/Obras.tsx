...
const Obras = ({ onObraSelect }: ObrasPageProps) => {
  ...
  */
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-2 py-4 md:px-4 md:py-8 space-y-4 md:space-y-8">
      {/* Header da Página */}
      <motion.div
      ...
      >
        ...
        {empresa && (
          ...
          >
            <Badge 
              variant="outline" 
              className="inline-flex items-center gap-1.5 md:gap-2 px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm font-medium bg-gradient-to-r from-grifo-secondary/10 to-grifo-secondary/5 border-grifo-secondary/30 text-grifo-primary rounded-full shadow-sm"
            >
              <Briefcase className="h-3.5 w-3.5 md:h-4 md:w-4 text-grifo-secondary" />
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-4">
          <div className="space-y-0.5 md:space-y-1">
            <h1 className="text-xl md:text-3xl font-heading font-bold text-grifo-primary flex items-center gap-2 md:gap-3">
              <Building2 className="h-6 w-6 md:h-8 md:w-8 text-grifo-secondary" />
              Minhas Obras
            </h1>
            <p className="text-grifo-primary/60 max-w-lg text-xs md:text-base hidden md:block">
          ...
          <Button
            ...
            className="bg-grifo-secondary hover:bg-grifo-secondary/90 text-white shadow-lg shadow-grifo-secondary/20 transition-all hover:-translate-y-0.5 h-9 md:h-11 text-sm md:text-base"
            size="lg"
          >
            <Plus className="mr-1.5 h-4 w-4 md:mr-2 md:h-5 md:w-5" /> Nova Obra
          </Button>
        </div>
      </motion.div>
